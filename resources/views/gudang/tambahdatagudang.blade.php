    ...
    <div class="container-fluid">
        <form class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input type="text" id="namasup" name="namasup" class="form-control" required="">
                </div>
            </div>
        ...
        <div class="row">
            <form>
                            ...
                            <div class="modal-body">
                                ...
                                <table class="table table-striped" id="myTable">
                                    ...
                                    <tbody>';
                                        ...
                                        @foreach(DB::table('barang')->get() as $row)
                                        <tr>
                                            <td>{{$row->kodebrg}}</td>
                                            <td>{{$row->namabrg}}</td>
                                            <td>{{$row->satuan}}</td>
                                            ...
                                            {{-- <td>{{$row->hargajual}}</td> --}}
                                            <td>
                                                <button class="btn btn-info btn-pilih"
                ...
                <div class="col-sm-1">
                    <div class="form-group">
                        ...
                        <input type="text" id="satuan" name="satuan" class="form-control"
                            value="<?php if (isset($_GET['satuan'])) {
                                echo $_GET['satuan'];
                            } ?>"required="" readonly>
                    </div>
                </div>
                ...
                <div class="col-sm-1">
                    <div class="form-group">
                        <label>Jumlah</label>
                        <input type="number" id="jumlah" name="jumlah" class="form-control" value="0"
                            required="">
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <input type="text" value="0" id="grandtotal" name="grandtotal" class="form-control"
                        required="">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-2">
                <a type="submit" href="{{ url('/gudang') }}" class="btn btn-danger btn-block cancel-btn">Cancel</a>
            </div>
        ...
        <script>
            ...
            $("#add").click(function(e) {
                ...
                if ($("input[name='jumlah']").val() > 0) {
                    ...
                    $(".data-table tbody").append("<tr data-kode='" + kode + "' data-nama='" + nama +
                        "' data-satuan='" + satuan + "' data-jumlah='" + jumlah + "' data-harga='" + harga +
                        "' data-total='" + total + "'><td>" + kode + "</td><td>" + nama + "</td><td>" + satuan +
                        "</td><td>" + jumlah + "</td><td>" + harga + "</td><td>" + total +
            ...
            function saveColumn() {
                ...
                $.get('http://localhost/latihanlaravelp12/gudangmaster/' + kodetr + '/' + tanggal + '/' + namasup + '/' + telp +
                    '/' + alamat + '/' + keterangan + '/' + grandtotal,
                    function() {});


                console.log('http://localhost/latihanlaravelp12/gudangmaster/' + kodetr + '/' + tanggal +
                    '/' + namasup + '/' + telp + '/' + alamat + '/' +
                    keterangan + '/' + grandtotal);
                ...
                $('#myTableisi tr').each(function() {
                    ...
                    var jumlah = $('td', this).eq(3).text();

                    var harga = $('td', this).eq(4).text();
                    ...
                    if (kode != "") {
                        ...
                        $.get('http://localhost/latihanlaravelp12/gudangdetail/' + kodetr + '/' + kode + '/' +
                            harga + '/' + jumlah,
                            function() {});


                        console.log('http://localhost/latihanlaravelp12/gudangdetail/' + kodetr + '/' + kode +
                            '/' + harga + '/' + jumlah);

                        window.location.href ="http://localhost/latihanlaravelp12/gudang";
