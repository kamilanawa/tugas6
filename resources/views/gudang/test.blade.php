    ...
    <div class="container-fluid">
        <form class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    <input type="tel" id="telpon" name="telpon" class="form-control" required="">
                </div>
            </div>
        ...
        <script>
            ...
            function saveColumn() {
                ...
                console.log('http://localhost/penjadwalan/transaksimaster.php?kodetr=' + kodetr + '&tanggal=' + tanggal +
                    '&namasupplier=' + namasupplier + '&telpon=' + telpon + '&alamat=' + alamat + '&keterangan=' +
                    keterangan + '&grandtotal=' + grandtotal);
